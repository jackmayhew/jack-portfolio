  ...
  <div class="mb-28">
    ...
    <div class="work-text pt-2 pb-6 sticky bottom-0">
      ...
      <div class="flex gap-4 mt-4">
        <a class="btn flex items-center gap-2 w-fit text-xl" :href="project.url" target="_blank" rel="noopener">
        Visit
        <Icon name="tabler:link" size="22" />
      </a>
      <NuxtLink class="btn flex items-center gap-2 w-fit text-xl" :to="`/projects/${project.slug}`" >
        Details
