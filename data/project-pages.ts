...
export const projectDetails = [
  {
    ...
    paragraphs: {
      ...
      2: `The results have been good - more donations are flowing in, volunteer applications are up, and adoption rates are climbing. Plus, the site's been ranking well, which means more eyes on adoption postings. Currently sitting second only to the SPCA for popular keywords like <a href="https://www.google.ca/search?q=cat+rescue+montreal" target="_blank" rel="noopener" class="json-link">'cat rescue montreal.'</a>`,
  ...
  },
  {
    ...
    paragraphs: {
      ...
      3: `It's nice getting messages from users who've discovered their new favourite camping spots through the site!`,
    },
  ...
  },
  {
    ...
    paragraphs: {
      ...
      2: `TabZen helps users focus on what matters - the music without the clutter. A simple fix for an annoying problem!`,
    },
