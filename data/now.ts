export const now = [
  ...
  },
  {
    ...
    Cool to see it actually help their mission - more donations, volunteers, and cat adoptions. Nothing beats working on projects that make a real difference.`,
  },
  {
    displayDate: 'December 2023',
    formateDate: '2022-11-01',
    desc: `Moved to Montreal! Still getting used to it but it's been good. My French is rusty but slowly coming back.
    Big fan of smoked meat sandwiches.`,
  },
  {
